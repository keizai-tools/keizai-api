export enum INVOCATION_RESPONSE {
  INVOCATION_UNAVAILABLE = 'Invocation not found',
  INVOCATION_NOT_PRESENT_BY_ID = 'Invocation with specified ID not found',
  INVOCATION_NOT_FOUND_FOR_USER = 'No invocations found for user',
  INVOCATION_NOT_FOUND_FOR_USER_AND_ID = 'No invocations found for user with specified ID',
  INVOCATION_NOT_FOUND_FOR_TEAM_AND_ID = 'No invocations found for team with specified ID',
  INVOCATION_SAVE_FAILED = 'Unable to save invocation',
  INVOCATION_DELETE_FAILED = 'Unable to delete invocation',
  INVOCATION_UPDATE_FAILED = 'Unable to update invocation',
